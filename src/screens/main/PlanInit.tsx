  ...
  return (
    <ScrollView>
      <ScrollView mt="10" p="3.5">
        <HStack mb="5">
          <Icon as={Entypo} name="chevron-thin-left" size="lg" color="muted.800" />
          <Center w="80">
        ...
        <Box>
          ...
          />
          <Box bg="muted.100" borderBottomLeftRadius="2xl" borderBottomRightRadius="2xl" p="3">
            ...
            <HStack alignItems="center" justifyContent="space-between" mb="5">
              ...
              <Icon as={Entypo} name="chevron-thin-right" color="muted.300" size="lg" />
            </HStack>
